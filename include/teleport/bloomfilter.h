...
#ifndef _TELEPORT_BLOOMFILTER_H
#define _TELEPORT_BLOOMFILTER_H
...
// int bloom_init_alloc(struct bloomfilter * bloom, int entries, double error);
 ...
 *
 */
void bloom_print(struct bloomfilter * bloom);
