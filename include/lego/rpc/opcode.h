...
#define P2M_PCACHE_INVALID	((__u32)0x20000001)
...
/* TELEPORT operations */
#define P2M_PUSHDOWN		((__u32)__NR_pushdown)
#define P2M_SYNCMEM		((__u32)__NR_syncmem)
#define M2P_TELEPORT_BASE		((__u32)0x70000000)
#define M2P_TELEPORT_PAGE_FAULT		(M2P_TELEPORT_BASE + 1)
#define M2P_TELEPORT_INVALIDATE		(M2P_TELEPORT_BASE + 2)
#define M2P_TELEPORT_COMPLETE		(M2P_TELEPORT_BASE + 3)
